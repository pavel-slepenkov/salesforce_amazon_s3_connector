...
<Profile xmlns="http://soap.sforce.com/2006/04/metadata">
    <applicationVisibilities>
        <application>Amazon_S3_Connector</application>
        <default>true</default>
        <visible>true</visible>
    </applicationVisibilities>
    <classAccesses>
        <apexClass>AmazonS3AuthorizationFramework</apexClass>
        <enabled>true</enabled>
    </classAccesses>
    <classAccesses>
        <apexClass>AmazonS3Connector</apexClass>
        <enabled>true</enabled>
    </classAccesses>
    <classAccesses>
        <apexClass>AmazonS3ConnectorTest</apexClass>
        <enabled>true</enabled>
    </classAccesses>
    <classAccesses>
        <apexClass>AmazonS3Constants</apexClass>
        <enabled>true</enabled>
    </classAccesses>
    <classAccesses>
        <apexClass>AmazonS3ServiceOperations</apexClass>
        <enabled>true</enabled>
    </classAccesses>
    <custom>false</custom>
    <fieldPermissions>
        <editable>true</editable>
        <field>AWSS3_Bucket_Connection__c.AWSS3_Bucket__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
        <field>AWSS3_Bucket_Connection__c.AWSS3_Credential__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
        <field>AWSS3_Bucket__c.Region__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
        <field>AWS_IAM_UserCredentials__c.Access_Key_Id__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
        <field>AWS_IAM_UserCredentials__c.Bucket_Name__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
        <field>AWS_IAM_UserCredentials__c.Region__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
        <field>AWS_IAM_UserCredentials__c.Secret_Access_Key__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <layoutAssignments>
        <layout>AWSS3_Bucket_Connection__c-Amazon S3 Bucket Connection Layout</layout>
    </layoutAssignments>
    <layoutAssignments>
        <layout>AWSS3_Bucket__c-Amazon S3 Bucket Layout</layout>
    </layoutAssignments>
    <layoutAssignments>
        <layout>AWS_IAM_UserCredentials__c-Amazon S3 Credential Layout</layout>
    </layoutAssignments>
    <objectPermissions>
        ...
        <object>AWSS3_Bucket_Connection__c</object>
    ...
    <objectPermissions>
        ...
        <allowRead>true</allowRead>
        <modifyAllRecords>true</modifyAllRecords>
        <object>AWS_IAM_UserCredentials__c</object>
        <viewAllRecords>true</viewAllRecords>
    </objectPermissions>
    <pageAccesses>
        <apexPage>AWSS3HomePage</apexPage>
        <enabled>true</enabled>
    </pageAccesses>
    <tabVisibilities>
        <tab>AWS_IAM_UserCredentials__c</tab>
